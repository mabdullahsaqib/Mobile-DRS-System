...
//     // Use magnitude threshold to detect stillness
//     double linearMag = sqrt(linearX * linearX + linearY * linearY + linearZ * linearZ);
//     const double smallThreshold = 0.5; // You can tweak this value

//     if (linearMag < smallThreshold) {
//       _stillCount++;
//     } else {
//       _stillCount = 0;
//     }
